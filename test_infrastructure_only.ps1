# GodsEye Phase 1 Infrastructure Test (Infrastructure Only)
# =========================================================
...
Write-Host "Spinning up infrastructure services (RabbitMQ + PostgreSQL)..."

# Spin up only infrastructure services in detached mode
docker-compose up -d rabbitmq postgres

if ($LASTEXITCODE -ne 0) {
    Write-Host "Failed to start infrastructure services"
    exit 1
}
