#!/usr/bin/env python3
"""
Test Simple AI Mode Click
Using the user's exact simple approach
"""
import asyncio
import random
...
async def simple_search(page: Page, query: str):
    """Simple search using AI Mode directly - EXACT USER CODE"""
    try:
        # Find search box
...
async def test_simple_ai_mode():
    """Test the simple AI Mode approach"""
    
    print("=" * 80)
    print("SIMPLE AI MODE TEST")
    print("Using user's exact approach: Fill -> Click AI Mode -> Done")
    print("=" * 80)
    print()
    ...
    print("3. Observe AI Mode link being clicked")
    print("4. Observe AI Mode response (no Enter pressed)")
    print()
    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            if result:
                print("SUCCESS: AI Mode link found and clicked")
                print()
                print("What to observe:")
                print("  - Did AI Mode panel open?")
                print("  - Did query execute without pressing Enter?")
                print("  - Did we get AI Mode response?")
                print()
                print("Wait 10 seconds to observe the result...")
                await asyncio.sleep(10)
            else:
                print("FAILED: AI Mode link NOT found")
                print()
                print("What to observe:")
                print("  - Is AI Mode link visible near search bar?")
                print("  - Does it appear after typing query?")
...
if __name__ == "__main__":
    print()
    print("Starting simple AI Mode test...")
    print("Using user's exact approach")
    print()
    
    success = asyncio.run(test_simple_ai_mode())
    ...
    if success:
        print("SUCCESS: Simple AI Mode approach works")
        print("No need to press Enter - just click AI Mode!")
    else:
        print("FAILED: Simple AI Mode approach didn't work")
        print("May need to adjust selectors or timing")
